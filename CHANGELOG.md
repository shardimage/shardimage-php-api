...
## [1.0.0-alpha35] - 2020-11-18
 ### Change
 - Minor change: added `guzzlehttp/guzzle:7.x` version in composer. Version `^6.2` is still supported.

## [1.0.0-alpha34] - 2020-11-17
 ### Change
 - Minor change: remove unused composer package.

## [1.0.0-alpha33] - 2020-09-25
 ### Change
 - Minor change: integer conversion in HttpException class.

## [1.0.0-alpha32] - 2020-06-17
 ### Remove
 - Minor change: removed the return type of `getCharset` function.

## [1.0.0-alpha31] - 2020-06-04
 ### Change
 - Changed response decoding process, added more checks and validation before decode.

## [1.0.0-alpha30] - 2020-05-19
 ### Change
